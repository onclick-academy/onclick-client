...
const RegisterForm = () => {
  ...
  return (
    ...
    >
      ...
      <div className="form-header" style={{display:"flex", gap:"0.6rem", flexDirection:mediaQuery? "column": "row"}}>
        <FormControl>
          <Input
            {...register("fullName", {
        ...
        {errors.fullName && (
          <FormHelperText>{String(errors.fullName?.message)}</FormHelperText>
        )}
      </div>
      ...
      <div className="form-header" style={{display:"flex", gap:"0.6rem", flexDirection:mediaQuery? "column": "row"}}>
        <FormControl>
          ...
          />
          {errors.username && (
            <FormHelperText>{String(errors.username?.message)}</FormHelperText>
          )}
        </FormControl>
        <FormControl>
          <Input
      ...
      <div className="form-header" style={{display:"flex", gap:"0.6rem", flexDirection:mediaQuery? "column": "row"}}>
        <FormControl style={{ margin: "0 10px", width: "45%" }}>
          ...
          />
          {errors.birthDate && (
            <FormHelperText>{String(errors.birthDate?.message)}</FormHelperText>
          )}
        </FormControl>
      ...
      <div className="form-header" style={{display:"flex", gap:"0.6rem", flexDirection:mediaQuery? "column": "row"}}>
        ...
        <FormControl style={{ margin: "0 10px" }}>
          ...
          />
          {errors.phoneNum && (
            <FormHelperText>{String(errors.phoneNum?.message)}</FormHelperText>
          )}
        </FormControl>
      ...
      <div className="form-header" style={{display:"flex", gap:"0.6rem", flexDirection:mediaQuery? "column": "row"}}>
        <FormControl>
          ...
          />
          {errors.bio && (
            <FormHelperText>{String(errors.bio?.message)}</FormHelperText>
          )}
        </FormControl>
      </div>
