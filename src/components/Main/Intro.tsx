    ...
    <div className={style['intro-container']}>
      <div className={style['left-container']}>
        <div className={style['left-side']}>
          ...
          <Image alt={'intro'} src={intro4} className={style['leftside-image']} />
        </div>
      ...
      <div className={style['right-container']}>
        <div>
          <div>
            ...
            <p>
              We are passionate about education and dedicated to providing high- quality learning resources for learners
              of all backgrounds.
            </p>
          </div>
          <div className={style['container-icons']}>
            <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
              <Image alt={'intro'} src={intro1} style={{ borderRadius: '7px' }} />
              <div style={{ width: '100%' }}>
            ...
            <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
              <Image alt={'intro'} src={intro2} style={{ borderRadius: '7px' }} />
              <div>
